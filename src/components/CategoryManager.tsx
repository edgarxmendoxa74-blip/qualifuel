                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex items-center space-x-3">
                       <div className={`h-2.5 w-2.5 rounded-full ${category.active ? 'bg-quali-primary shadow-[0_0_10px_rgba(154,202,60,0.8)]' : 'bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]'}`} />
