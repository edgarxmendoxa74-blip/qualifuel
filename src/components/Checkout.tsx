...
import { ArrowLeft, Clock, ShieldCheck, Wallet, MapPin, User, Phone, Users, MessageSquare, Receipt, Truck, CreditCard } from 'lucide-react';
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-10 border border-white/10 shadow-2xl">
               ...
               <div className="grid grid-cols-3 gap-3 md:gap-6 mb-8 md:mb-10">
                  {[
                    ...
                    >
                      <div className="text-2xl md:text-4xl mb-2 md:mb-3 transform group-hover:scale-110 transition-transform">{option.icon}</div>
